...
class GLROContrast(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_clusters=2, individualRank=1, commonRank=1, shapeObject=None, sourceModes=None,
    ...
    def fit_transform(self, X, y=None, individualRank=None, commonRank=None, maxitnum=None, epsilon=None, verbose=False, recover=True):
        '''
        ...
        individualComponents = self._fit_transform_fun(X, individualRank, commonRank, maxitnum, epsilon, verbose, recover)
    ...
    def _fit_transform_fun(self, X, individualRank=None, commonRank=None, maxitnum=None, epsilon=None, verbose=False,
                          recover=True):        
        if epsilon is None:
...
class GTLDContrast(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_clusters=2, individualRank=1, commonRank=1, shapeObject=None, sourceModes=None,
                 method='als', nShortModes=None, constraintMethod='projected',
                 fullModesConstraint=None, modeSizeFirstPriority=True, maxitnum=100, epsilon=1e-5):
        # assertions
        # shape of input except Nsubject axis
        assert shapeObject is not None, "Unspecified shape of feature space"
        # specific parameters check (depending on method)
